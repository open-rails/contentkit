...
func TestContentRefKeyVersionAndJSON(t *testing.T) {
	...
	if work.String() != "doujins/gallery/01920000-0000-7000-8000-000000000001" || version.String() != "doujins/gallery/01920000-0000-7000-8000-000000000001@v1" {
	...
	if err != nil || string(b) != `[{"tenant_id":"doujins","content_kind":"gallery","content_id":"01920000-0000-7000-8000-000000000001"},{"tenant_id":"doujins","content_kind":"gallery","content_id":"01920000-0000-7000-8000-000000000001","content_version_id":"v1"}]` {
