...
gen() { # name w h seconds ext
	[ -f "$dir/$1.$5" ] && return
	taskset -c 0-7 nice -n 19 ffmpeg -v error -nostdin -f lavfi -i "testsrc2=s=$2x$3:r=30:d=$4,noise=alls=7:allf=t+u,hue=H=0.2*t" \
...
gen hd120 1920 1080 120 mp4
gen uhd32 3840 2160 32 mkv
